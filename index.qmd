...
model_SessionH_1_lmer<- lmer(
  SessionH_lead1 ~ Pride_cm_centered * PA_cm_centered + (1 | ID), 
  data = long_df, 
  na.action = na.omit, 
  REML = TRUE
)
...
pride_dynamics_plot<- plot_model(
  model_SessionKM_4,
  type = "int",
  terms = c("Pride_cm_centered", "Dynamics_centered"),
